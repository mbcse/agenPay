...
2. If the user confirms or asks to proceed with previously extracted details, START the payment workflow:
   a) FIRST: Use createPaymentLink tool to generate X402Pay payment link
...
- createPaymentLink: Create X402Pay payment link for crypto payments
...
- If new request: Extract details and explain what would happen next
- If user confirms: "Great! I'll proceed with the payment request..." then START with createPaymentLink tool ONLY
...
1. FIRST: Call createPaymentLink tool with extracted payment data
